...
# )
  ...
  summary <- reactive({
    ...
    data.frame(
      ...
      s_jumps = length(which(Window()$C.jh < 20 & Window()$C.jh > 0 & Window()$C.Jump == 1)),
      m_jumps = length(which(Window()$C.jh > 20 & Window()$C.jh < 40 & Window()$C.Jump == 1)),
      l_jumps = length(which(Window()$C.jh > 40 & Window()$C.jh < 80 & Window()$C.Jump == 1)),
